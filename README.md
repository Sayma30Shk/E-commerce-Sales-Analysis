# E-commerce Sales Analysis Dashboard
 An interactive dashboard built to analyze product trends,marketing channels, payment methods and yearly sales performance
 ## Data cleaning 
 Before making the charts ,I cleaned the raw dataset in Excel using these steps :
 1. **Imported the Data:** I loaded the raw ecommerce sales dataset into Excel.
 2. **Fixed Missing Values:**  Used filters to check the coloumns and found blank cells in 'CouponCode' column and replaced these cels  with 'NULL'.
 3. **Created Time Columns:** Extracted Year and Month from the Dat' column.
 4. **Removed Duplicates:** Ran a duplicate check across Sheet1 to ensure none of the entries  were repeated.
